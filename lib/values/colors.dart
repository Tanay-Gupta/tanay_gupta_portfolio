...
class AppColors {
  ...
  static const Color socialappcolor = Color(0xFFB41100);
  ...
  static const Color notifyxcolor = Color(0xFF5A458D);
  static const Color notifyxSelectedNavTitle = Color(0xFF7D54A9);
  static const Color flutterCatalogAppLogo = Color(0xFF7D54A9);

  static const Color datingcolor = Color(0xFF0E1319);
  static const Color datingcolorNavTitle = Color(0xFF162726);

  static const Color citizencolor = Color(0xFF2DB8AF);
  static const Color citizenNavTitle = Color(0xFF0A0E32);
  static const Color citizenSelectedNavTitle = Color(0xFF377F8C);
  static const Color citizencAppLogo = Color(0xFF2DB8AF);
}
